...
class TestIf : InterpreterTest {
  ...
  func testTrueCase() {
    expectThat("(if (.> 10 1) (do (.print \"good\") 10))", shouldEvalTo: .IntegerLiteral(10))
  ...
  func testTrueCaseWithElse() {
    expectThat("(if (.> 10 1) (do (.print \"good\") 10) (do (.print \"bad\") 20))",
      shouldEvalTo: .IntegerLiteral(10))
    expectOutputBuffer(toBe: "good")
  }
  ...
  func testFalseCase() {
    ...
    expectThat("(if (.> 1 10) (do (.print \"bad\") 10))", shouldEvalTo: .NilLiteral)
  ...
  func testFalseCaseWithElse() {
    expectThat("(if (.> 1 10) (do (.print \"bad\") 10) (do (.print \"good\") 20))", shouldEvalTo: .IntegerLiteral(20))
    expectOutputBuffer(toBe: "good")
  }

  /// A predicate evaluating to 'nil' should be treated as false.
  func testNilIsFalse() {
    expectThat("(if nil \\a \\c)", shouldEvalTo: .CharacterLiteral("c"))
  }
