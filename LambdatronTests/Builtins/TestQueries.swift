...
class TestIsNil : InterpreterTest {
  ...
  func testIsNilWithOthers() {
    ...
    expectThat("(.nil? #\"[0-9]+\")", shouldEvalTo: false)
...
class TestIsNumber : InterpreterTest {
  ...
  func testIsNumberWithOthers() {
    ...
    expectThat("(.number? #\"[0-9]+\")", shouldEvalTo: false)
...
class TestIsInt : InterpreterTest {
  ...
  func testIsIntWithOthers() {
    ...
    expectThat("(.int? #\"[0-9]+\")", shouldEvalTo: false)
...
class TestIsFloat : InterpreterTest {
  ...
  func testIsFloatWithOthers() {
    ...
    expectThat("(.float? #\"[0-9]+\")", shouldEvalTo: false)
...
class TestIsString : InterpreterTest {
  ...
  func testIsStringWithOthers() {
    ...
    expectThat("(.string? #\"[0-9]+\")", shouldEvalTo: false)
...
class TestIsChar : InterpreterTest {
  ...
  func testIsCharWithOthers() {
    ...
    expectThat("(.char? #\"[0-9]+\")", shouldEvalTo: false)
...
class TestIsSymbol : InterpreterTest {
  ...
  func testIsSymbolWithOthers() {
    ...
    expectThat("(.symbol? #\"[0-9]+\")", shouldEvalTo: false)
...
class TestIsKeyword : InterpreterTest {
  ...
  func testIsKeywordWithOthers() {
    ...
    expectThat("(.keyword? #\"[0-9]+\")", shouldEvalTo: false)
...
class TestIsFn : InterpreterTest {
  ...
  func testWithOthers() {
    ...
    expectThat("(.fn? #\"[0-9]+\")", shouldEvalTo: false)
...
class TestIsEval : InterpreterTest {
  ...
  func testWithOthers() {
    expectThat("(.eval? 1025)", shouldEvalTo: false)
    expectThat("(.eval? 3.141592)", shouldEvalTo: false)
    expectThat("(.eval? nil)", shouldEvalTo: false)
    expectThat("(.eval? true)", shouldEvalTo: false)
    expectThat("(.eval? false)", shouldEvalTo: false)
    expectThat("(.eval? \"\")", shouldEvalTo: false)
    expectThat("(.eval? #\"[0-9]+\")", shouldEvalTo: false)
    expectThat("(.eval? \\a)", shouldEvalTo: false)
    expectThat("(.eval? ())", shouldEvalTo: false)
  }
...
class TestIsTrue : InterpreterTest {
  ...
  func testIsTrueWithOthers() {
    ...
    expectThat("(.true? #\"[0-9]+\")", shouldEvalTo: false)
...
class TestIsFalse : InterpreterTest {
  ...
  func testIsFalseWithOthers() {
    ...
    expectThat("(.false? #\"[0-9]+\")", shouldEvalTo: false)
