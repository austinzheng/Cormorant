...
class TestGetBuiltin : InterpreterTest {
  ...
  func testStrBadBoundsWithFallback() {
    ...
    expectThat("(.get \"foobar\" -1 12345)", shouldEvalTo: .IntAtom(12345))
    expectThat("(.get \"the quick brown fox jumps over the lazy dog\" 1052 true)", shouldEvalTo: .BoolAtom(true))
  }
  ...
  func testStrInvalidIdxWithFallback() {
    expectThat("(.get \"foobar\" true 1349)", shouldEvalTo: .IntAtom(1349))
    expectThat("(.get \"foobar\" false 1322)", shouldEvalTo: .IntAtom(1322))
    expectThat("(.get \"foobar\" 1.00002 6921)", shouldEvalTo: .IntAtom(6921))
    expectThat("(.get \"foobar\" :0 778)", shouldEvalTo: .IntAtom(778))
    expectThat("(.get \"foobar\" \\0 5617)", shouldEvalTo: .IntAtom(5617))
    expectThat("(.get \"foobar\" () 12)", shouldEvalTo: .IntAtom(12))
    expectThat("(.get \"foobar\" [] 86)", shouldEvalTo: .IntAtom(86))
    expectThat("(.get \"foobar\" {} 3)", shouldEvalTo: .IntAtom(3))
    expectThat("(.get \"foobar\" #\"0+\" 999)", shouldEvalTo: .IntAtom(999))
    expectThat("(.get \"foobar\" \"0\" -8126)", shouldEvalTo: .IntAtom(-8126))
  }
  ...
  func testVectorInBoundsNoFallback() {
    expectThat("(.get [true false \"foo\" 152 \"bar\"] 0)", shouldEvalTo: .BoolAtom(true))
    expectThat("(.get [true false \"foo\" 152 \"bar\"] 4)", shouldEvalTo: .StringAtom("bar"))
    expectThat("(.get [true false \"foo\" 152 \"bar\"] 3)", shouldEvalTo: .IntAtom(152))
    expectThat("(.get [3.141592] 0)", shouldEvalTo: .FloatAtom(3.141592))
  }
  ...
  func testVectorInBoundsWithFallback() {
    expectThat("(.get [true false \"foo\" 152 \"bar\"] 0 \"fallback\")", shouldEvalTo: .BoolAtom(true))
    expectThat("(.get [true false \"foo\" 152 \"bar\"] 4 \"fallback\")", shouldEvalTo: .StringAtom("bar"))
    expectThat("(.get [true false \"foo\" 152 \"bar\"] 3 \"fallback\")", shouldEvalTo: .IntAtom(152))
    expectThat("(.get [3.141592] 0  \"fallback\")", shouldEvalTo: .FloatAtom(3.141592))
  }
  ...
  func testVectorBadBoundsWithFallback() {
    ...
    expectThat("(.get [true false \"foo\" 152 \"bar\"] 5 998)", shouldEvalTo: .IntAtom(998))
  ...
  func testVectorInvalidIdxWithFallback() {
    expectThat("(.get [0 1 2 3 4] true -98)", shouldEvalTo: .IntAtom(-98))
    ...
    expectThat("(.get [0 1 2 3 4] :0 699812.259)", shouldEvalTo: .FloatAtom(699812.259))
    expectThat("(.get [0 1 2 3 4] \\0 1276)", shouldEvalTo: .IntAtom(1276))
    expectThat("(.get [0 1 2 3 4] () false)", shouldEvalTo: .BoolAtom(false))
    expectThat("(.get [0 1 2 3 4] [] nil)", shouldEvalTo: .Nil)
    expectThat("(.get [0 1 2 3 4] {} 111992)", shouldEvalTo: .IntAtom(111992))
  ...
  func testMapValidKeyNoFallback() {
    ...
    expectThat("(.get {:foo \"foo\" \"bar\" \"bar\" 'baz 152} 'baz)", shouldEvalTo: .IntAtom(152))
    expectThat("(.get {152 true} 152)", shouldEvalTo: .BoolAtom(true))
  }
  ...
  func testMapValidKeyWithFallback() {
    ...
    expectThat("(.get {:foo \"foo\" \"bar\" \"bar\" 'baz 152} 'baz \"fallback\")", shouldEvalTo: .IntAtom(152))
    expectThat("(.get {152 true} 152 \"fallback\")", shouldEvalTo: .BoolAtom(true))
  }
  ...
  func testMapInvalidKeyWithFallback() {
    expectThat("(.get {} \"foo\" 9612)", shouldEvalTo: .IntAtom(9612))
    ...
    expectThat("(.get {:foo \\f :bar \\b :baz \\z} nil 61)", shouldEvalTo: .IntAtom(61))
    expectThat("(.get {:foo \\f :bar \\b :baz \\z} \"foo\" true)", shouldEvalTo: .BoolAtom(true))
  ...
  func testGetInvalidTypeWithFallback() {
    expectThat("(.get '(1 2 3 4 5 6) 1 5097)", shouldEvalTo: .IntAtom(5097))
    expectThat("(.get \\c 0 nil)", shouldEvalTo: .Nil)
    expectThat("(.get :c 0 \\z)", shouldEvalTo: .CharAtom("z"))
    expectThat("(.get 'c 0 0)", shouldEvalTo: .IntAtom(0))
    expectThat("(.get true 0 812)", shouldEvalTo: .IntAtom(812))
    expectThat("(.get false 0 11011)", shouldEvalTo: .IntAtom(11011))
    expectThat("(.get 1523 0 2738.886188241)", shouldEvalTo: .FloatAtom(2738.886188241))
    expectThat("(.get -9.991238 0 true)", shouldEvalTo: .BoolAtom(true))
