...
class TestScoping : InterpreterTest {
  ...
  func testNonShadowedVarsInLet() {
    run(input: "(def a 500)")
    run(input: "(def b 21)")
    expectThat("(let [c 20 d 18] (.println a) (.println b) (.println c) (.println d))", shouldEvalTo: .nilValue)
  ...
  func testSequentialBinding() {
    expectThat("(let [a 4 b (.+ a 10) c (.+ b a)] (.println a) (.println b) (.println c))", shouldEvalTo: .nilValue)
  ...
  func testFunctionInLet() {
    run(input: "(let [a 19 b 20] (.print \"a1\" a) (.print \"b1\" b) ((fn [b c] (.print \"a2\" a) (.print \"b2\" b) (.print \"c2\" c)) 21 22))")
  ...
  func testLetInFunction() {
    run(input: "((fn [a b] (.print \"a1\" a) (.print \"b1\" b) (let [b 29 c 88] (.print \"a2\" a) (.print \"b2\" b) (.print \"c2\" c))) -7 153)")
  ...
  func testFunctionShadowingVar() {
    run(input: "(def a 10)")
    run(input: "(def b 23)")
    run(input: "(do (.print \"a1\" a) (.print \"b1\" b))")
    run(input: "((fn [b c] (.print \"a2\" a) (.print \"b2\" b) (.print \"c2\" c)) 45 76)")
