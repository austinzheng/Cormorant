...
/// Read in a string from the host interpreter's readInput function, and then expand it into a Cormorant form.
...
/// Given a string as an argument, read and expand it into a Cormorant form.
...
/// Given a string and a context, lex, parse, and reader-expand the string into a Cormorant data structure.
