...
func sb_sb(_ args: Params, _ ctx: Context) -> EvalResult {
  let fn = ".sb"
  guard args.isEmpty || args.count == 1 else {
    return .Failure(EvalError.arityError(expected: "0 or 1", actual: args.count, fn))
  }
  return args.isEmpty
...
func sb_append(_ args: Params, _ ctx: Context) -> EvalResult {
  let fn = ".sb-append"
